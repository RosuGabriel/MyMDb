        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WatchedTime = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContinueWatchings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ContinueWatchings_Media_MediaId",
                        column: x => x.MediaId,
                        principalTable: "Media",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "b8130e4d-0fd1-45f9-94d6-3f05d6f442d8", null, "user", "USER" },
                    { "f103c864-51b9-45b4-b56c-2f31dc78becc", null, "admin", "ADMIN" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "0f883944-ccf3-4ea1-8fec-d20317378a5d", 0, true, "434408eb-1712-449e-a84e-26cf8f5c9f83", "mymdbAdmin@mymdb2024.com", true, false, null, "MYMDBADMIN@MYMDB2024.COM", "ADMIN", "AQAAAAIAAYagAAAAEIp8I9qagNPp2Q16LgDqvxxIyQ422E+HvaI7zGa9JuohX6R2veDnFWF2oeY60EMS3Q==", null, false, "a2993895-48f4-4d0b-bb4c-c884384aa815", false, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "b8130e4d-0fd1-45f9-94d6-3f05d6f442d8", "0f883944-ccf3-4ea1-8fec-d20317378a5d" },
                    { "f103c864-51b9-45b4-b56c-2f31dc78becc", "0f883944-ccf3-4ea1-8fec-d20317378a5d" }
                });

            migrationBuilder.InsertData(
                table: "UserProfiles",
                columns: new[] { "UserId", "DateCreated", "DateModified", "ProfilePicPath", "UserName" },
                values: new object[] { "0f883944-ccf3-4ea1-8fec-d20317378a5d", null, null, null, "Admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContinueWatchings_MediaId",
                table: "ContinueWatchings",
                column: "MediaId");
